...
// Stubbed out calls to native methods such that apps using
// this library don't have to be run in emulator or device.
...
public final class Log {
    ...
    public static final String [] priorityNames = {
    	"undefined", "undefined", "VERBOSE", "DEBUG", "INFO", "WARN", "ERROR", "ASSERT"  	
    };
    ...
    public static int println_native(int bufID, int priority, String tag, String msg) {
    	...
    	sb.append(bufID).append(':').append(priorityNames[priority]).append(':').append(tag).append(": ");
    	sb.append(msg);
    	int len = sb.length();
